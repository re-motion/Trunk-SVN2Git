...
namespace Remotion.Linq.EagerFetching.Parsing
{
  ...
  /// these  methods in order for <see cref="FetchManyExpressionNode"/> to be used. See also <see cref="T:Remotion.Data.DomainObjects.Linq.FluentFetchRequest{TQueried,TFetch}"/>.
  /// </remarks>
