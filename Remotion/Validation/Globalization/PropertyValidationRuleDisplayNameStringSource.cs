...
{
  public class PropertyValidationRuleDisplayNameStringSource : IStringSource
  {
    private readonly PropertyValidationRule _propertyValidationRule;
    ...
    public PropertyValidationRuleDisplayNameStringSource (
        PropertyValidationRule propertyValidationRule, Type typeToValidate, IMemberInformationGlobalizationService globalizationService)
    {
      ArgumentUtility.CheckNotNull ("propertyValidationRule", propertyValidationRule);
    ...
    {
      var propertyInformation = _propertyValidationRule.Property;
