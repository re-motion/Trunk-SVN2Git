...
namespace Remotion.Validation.Validators
{
  public class InclusiveBetweenValidator : PropertyValidator, IBetweenValidator
  {
    ...
    public InclusiveBetweenValidator ([NotNull] IComparable from, [NotNull] IComparable to, IComparer comparer = null, [CanBeNull] IValidationMessage validationMessage = null)
