...
namespace Remotion.Validation.UnitTests.RuleBuilders
{
  ...
  public class AddingComponentPropertyRuleTest
  {
    ...
    public void Create_MemberInfoIsNoPropertyInfo_ExceptionIsThrown ()
    {
      ...
      Assert.That (
          ...
          Throws.ArgumentException
              .And.Message.EqualTo ("An 'AddingComponentPropertyRule' can only created for property members.\r\nParameter name: expression"));
    }
    ...
    public void Create_PropertyDeclaredInBaseClass ()
    {
      ...
      Assert.That (propertyInfo.ReflectedType, Is.EqualTo (typeof (Person)));
    }
