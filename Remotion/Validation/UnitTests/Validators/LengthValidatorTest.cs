...
namespace Remotion.Validation.UnitTests.Validators
{
  ...
  public class LengthValidatorTest : ValidatorTestBase
  {
    ...
    public void Validate_WithPropertyValueNull_ReturnsNoValidationFailures ()
    {
      ...
      var validator = new LengthValidator (0, 0);
    ...
    public void Validate_WithPropertyValueLengthTooShort_ReturnsSingleValidationFailure ()
    {
      ...
      Assert.That (validationFailures[0].ErrorMessage, Is.EqualTo ("Enter between 1 and 4 characters."));
      Assert.That (validationFailures[0].LocalizedValidationMessage, Is.EqualTo ("Enter between 1 and 4 characters."));
    }

    [Test]
    public void Validate_WithPropertyValueLengthTooShortAndCustomValidationMessage_ReturnsSingleValidationFailureWithCustomValidationMessage ()
    {
      var propertyValidatorContext = CreatePropertyValidatorContext ("");
      var validator = new LengthValidator (1, 4, new InvariantValidationMessage ("Custom validation message: '{MinLength}', '{MaxLength}'."));
    ...
    {
      var propertyValidatorContext = CreatePropertyValidatorContext ("12345");
      var validator = new LengthValidator (1, 4);
