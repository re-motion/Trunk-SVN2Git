...
namespace Remotion.Validation.UnitTests.Validators
{
  ...
  public class GreaterThanValidatorTest : ValidatorTestBase
  {
    ...
    public void Validate_WithPropertyValueGreaterThanComparisonValue_ReturnsNoValidationFailures ()
    {
      ...
      var validator = new GreaterThanValidator (3);
    ...
    public void Validate_WithPropertyValueEqualsComparisonValue_ReturnsSingleValidationFailure ()
    {
      ...
      Assert.That (validationFailures[0].ErrorMessage, Is.EqualTo ("Enter a value that is greater than '3'."));
      Assert.That (validationFailures[0].LocalizedValidationMessage, Is.EqualTo ("Enter a value that is greater than '3'."));
    }
    ...
    {
      var propertyValidatorContext = CreatePropertyValidatorContext (2);
      var validator = new GreaterThanValidator (3, validationMessage: new InvariantValidationMessage ("Custom validation message: '{ComparisonValue}'."));
    ...
    public void Validate_WithCustomComparer_UsesComparer ()
    {
      ...
      var validator = new GreaterThanValidator ("comparisonValue", equalityComparerMock);
