...
namespace Remotion.Validation.UnitTests.Validators
{
  ...
  public class LessThanValidatorTest : ValidatorTestBase
  {
    ...
    public void Validate_WithPropertyValueGreaterThanComparisonValue_ReturnsSingleValidationFailure ()
    {
      ...
      var validator = new LessThanValidator (3);
      ...
      Assert.That (validationFailures[0].ErrorMessage, Is.EqualTo ("Enter a value that is be less than '3'."));
      Assert.That (validationFailures[0].LocalizedValidationMessage, Is.EqualTo ("Enter a value that is be less than '3'."));
    }
    ...
    {
      var propertyValidatorContext = CreatePropertyValidatorContext (4);
      var validator = new LessThanValidator (3, validationMessage: new InvariantValidationMessage ("Custom validation message: '{ComparisonValue}'."));
    ...
    public void Validate_WithCustomComparer_UsesComparer ()
    {
      ...
      var validator = new LessThanValidator ("comparisonValue", equalityComparerMock);
