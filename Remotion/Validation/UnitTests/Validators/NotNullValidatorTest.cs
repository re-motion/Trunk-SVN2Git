...
namespace Remotion.Validation.UnitTests.Validators
{
  ...
  public class NotNullValidatorTest : ValidatorTestBase
  {
    ...
    [Test]
    public void Validate_WithNullAndCustomValidationMessage_ReturnsSingleValidationErrorWithCustomValidationMessage ()
    {
    ...
    public void Validate_WithNull_ReturnsSingleValidationFailure ()
    {
      ...
      Assert.That (validationFailures[0].LocalizedValidationMessage, Is.EqualTo ("Enter a value."));
    }
  }
}