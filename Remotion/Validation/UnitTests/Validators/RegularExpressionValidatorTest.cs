...
namespace Remotion.Validation.UnitTests.Validators
{
  ...
  public class RegularExpressionValidatorTest : ValidatorTestBase
  {
    ...
    public void Validate_WithPropertyValueNoString_ReturnsNoValidationFailures ()
    {
      ...
      var validator = new RegularExpressionValidator (new Regex (@"^\d$"));
    ...
    public void Validate_WithPatternNull_ThrowsArgumentNullException ()
    {
      ...
      {
        Assert.That (
            () => new RegularExpressionValidator (null),
    ...
    public void Validate_WithPropertyValueMatchingPattern_ReturnsNoValidationFailures ()
    {
      ...
      var validator = new RegularExpressionValidator (new Regex (@"^\d{1}$"));
    ...
    public void Validate_WithPropertyValueNotMatchingPattern_ReturnsSingleValidationFailure ()
    {
      ...
      Assert.That (validationFailures[0].ErrorMessage, Is.EqualTo ("Enter a value in the correct format."));
      Assert.That (validationFailures[0].LocalizedValidationMessage, Is.EqualTo ("Enter a value in the correct format."));
    }

    [Test]
    public void Validate_WithPropertyValueNotMatchingPatternAndCustomValidationMessage_ReturnsSingleValidationFailureWithCustomValidationMessage ()
    {
      var propertyValidatorContext = CreatePropertyValidatorContext ("a");
