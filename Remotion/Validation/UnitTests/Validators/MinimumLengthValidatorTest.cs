...
namespace Remotion.Validation.UnitTests.Validators
{
  ...
  public class MinimumLengthValidatorTest : ValidatorTestBase
  {
    ...
    public void Validate_WithPropertyValueNull_ReturnsNoValidationFailures ()
    {
      ...
      var validator = new MinimumLengthValidator (0);
    ...
    public void Validate_WithPropertyValueStringShorterThanComparisonValue_ReturnsSingleValidationError ()
    {
      ...
      var validator = new MinimumLengthValidator ("short".Length + 1);
      ...
      Assert.That (validationFailures[0].ErrorMessage, Is.EqualTo ("Enter between 6 and  characters."));
      Assert.That (validationFailures[0].LocalizedValidationMessage, Is.EqualTo ("Enter between 6 and  characters."));
    }

    [Test]
    public void Validate_WithPropertyValueStringShorterThanComparisonValueAndCustomValidationMessage_ReturnsSingleValidationErrorWithCustomValidationMessage ()
    {
      var propertyValidatorContext = CreatePropertyValidatorContext ("short");
      var validator = new MinimumLengthValidator ("short".Length + 1, new InvariantValidationMessage ("Custom validation message: '{MinLength}', '{MaxLength}'."));
    ...
    {
      var propertyValidatorContext = CreatePropertyValidatorContext ("short");
      var validator = new MinimumLengthValidator ("short".Length);
