...
namespace Remotion.Validation.UnitTests.Validators
{
  ...
  public class GreaterThanOrEqualValidatorTest : ValidatorTestBase
  {
    ...
    public void Validate_WithPropertyValueEqualsComparisonValue_ReturnsNoValidationFailures ()
    {
      ...
      var validator = new GreaterThanOrEqualValidator (3);
    ...
    public void Validate_WithPropertyValueLessThanComparisonValue_ReturnsSingleValidationFailure ()
    {
      ...
      Assert.That (validationFailures[0].ErrorMessage, Is.EqualTo ("Enter a value that is greater than or equal to '3'."));
      Assert.That (validationFailures[0].LocalizedValidationMessage, Is.EqualTo ("Enter a value that is greater than or equal to '3'."));
    }

    [Test]
    public void Validate_WithPropertyValueLessThanComparisonValueAndCustomValidationMessage_ReturnsSingleValidationFailureWithCustomValidationMessage ()
    {
      var propertyValidatorContext = CreatePropertyValidatorContext (2);
      var validator = new GreaterThanOrEqualValidator (3, validationMessage: new InvariantValidationMessage ("Custom validation message: '{ComparisonValue}'."));
    ...
    {
      var equalityComparerMock = MockRepository.GenerateMock<IComparer>();
      ...
      var validator = new GreaterThanOrEqualValidator ("comparisonValue", equalityComparerMock);
