...
namespace Remotion.Validation.UnitTests.Validators
{
  ...
  public class LessThanOrEqualValidatorTest : ValidatorTestBase
  {
    ...
    public void Validate_WithPropertyValueGreaterThanComparisonValue_ReturnsSingleValidationFailure ()
    {
      ...
      var validator = new LessThanOrEqualValidator (3);
      ...
      Assert.That (validationFailures[0].ErrorMessage, Is.EqualTo ("Enter a value that is less than or equal to '3'."));
      Assert.That (validationFailures[0].LocalizedValidationMessage, Is.EqualTo ("Enter a value that is less than or equal to '3'."));
    }
    ...
    [Test]
    public void Validate_WithPropertyValueGreaterThanComparisonValueAndCustomValidationMessage_ReturnsSingleValidationFailureWithCustomValidationMessage ()
    {
      var propertyValidatorContext = CreatePropertyValidatorContext (4);
      var validator = new LessThanOrEqualValidator (3, validationMessage: new InvariantValidationMessage ("Custom validation message: '{ComparisonValue}'."));
    ...
    public void Validate_WithCustomComparer_UsesComparer ()
    {
      ...
      var validator = new LessThanOrEqualValidator ("comparisonValue", equalityComparerMock);
