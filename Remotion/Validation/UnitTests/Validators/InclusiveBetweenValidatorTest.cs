...
{
  [TestFixture]
  public class InclusiveBetweenValidatorTest : ValidatorTestBase
  {
    [Test]
    public void Validate_WithPropertyValueNull_ReturnsNoValidationFailures ()
    {
      ...
      var validator = new InclusiveBetweenValidator (2, 4);
    ...
    public void Ctor_WithFromGreaterThanTo_ThrowsArgumentOutOfRangeException ()
    {
      ...
      {
        Assert.That (
            () => new InclusiveBetweenValidator (2, 1),
    ...
    public void Ctor_WithFromDifferentTypeThanTo_ThrowsArgumentException ()
    {
      ...
      {
        Assert.That (
            () => new InclusiveBetweenValidator (2f, 3m),
    ...
    public void Validate_WithPropertyValueDifferentTypeThanFrom_ReturnsNoValidationFailures ()
    {
      ...
      var validator = new InclusiveBetweenValidator (2m, 4m);
    ...
    public void Validate_WithPropertyValueLessThanLowerBoundary_ReturnsSingleValidationFailure ()
    {
      ...
      Assert.That (validationFailures[0].ErrorMessage, Is.EqualTo ("Enter a value between 2 and 4."));
      Assert.That (validationFailures[0].LocalizedValidationMessage, Is.EqualTo ("Enter a value between 2 and 4."));
    }
    ...
    [Test]
    public void Validate_WithPropertyValueLessThanLowerBoundaryAndCustomValidationMessage_ReturnsSingleValidationFailureWithCustomValidationMessage ()
    {
      var propertyValidatorContext = CreatePropertyValidatorContext (1);
      var validator = new InclusiveBetweenValidator (2, 4, validationMessage: new InvariantValidationMessage ("Custom validation message: '{From}', '{To}'."));
    ...
    public void Validate_WithIComparable_CallsCompareTo ()
    {
      ...
      var validator = new InclusiveBetweenValidator (fromStub, toStub);
    ...
    public void Validate_WithIComparer_UsesComparer ()
    {
      ...
      comparerMock.Expect (_ => _.Compare (10, 1)).Return (0);
      comparerMock.Expect (_ => _.Compare (10, 3)).Return (0);
      var propertyValidatorContext = CreatePropertyValidatorContext (10);
      var validator = new InclusiveBetweenValidator (1, 3, comparerMock);
