...
namespace Remotion.Validation.UnitTests.Validators
{
  ...
  public class PredicateValidatorTest : ValidatorTestBase
  {
    ...
    public void Validate_WithPredicateTrue_ReturnsNoValidationFailures ()
    {
      ...
      var validator = new PredicateValidator ((instanceToValidate, propertyValue, context) => true);
    ...
    {
      var propertyValidatorContext = CreatePropertyValidatorContext (1);
      var validator = new PredicateValidator ((instanceToValidate, propertyValue, context) => false);
      ...
      Assert.That (validationFailures[0].ErrorMessage, Is.EqualTo ("Enter a value that meets the specified condition."));
      Assert.That (validationFailures[0].LocalizedValidationMessage, Is.EqualTo ("Enter a value that meets the specified condition."));
    }
    ...
    [Test]
    public void Validate_WithPredicateFalseAndCustomValidationMessage_ReturnsSingleValidationFailureWithCustomValidationMessage ()
    {
      var propertyValidatorContext = CreatePropertyValidatorContext (1);
