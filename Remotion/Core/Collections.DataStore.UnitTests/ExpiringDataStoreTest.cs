...
namespace Remotion.Collections.DataStore.UnitTests
{
  ...
  public class ExpiringDataStoreTest
  {
    ...
    private IExpirationPolicy<object, DateTime, DateTime> _expirationPolicyMock = null!;

    private ExpiringDataStore<string, object, DateTime, DateTime> _dataStore = null!;

    private object _fakeValue = null!;
    private object _fakeValue2 = null!;
    private object _fakeValue3 = null!;
