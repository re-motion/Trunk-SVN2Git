  ...
  public class TabbedMenuControlObjectTest : IntegrationTest
  {
    ...
    public void TestIsDisabled_SetMethodsThrow ()
    {
      ...
      Assert.That (
          ...
          Throws.Exception.Message.EqualTo (AssertionExceptionUtility.CreateCommandDisabledException (Driver, "SelectItem.WithDisplayText").Message));
      Assert.That (
          () => control.SelectItem().WithDisplayTextContains ("DisabledCommandTabTitle"),
          Throws.Exception.Message.EqualTo (AssertionExceptionUtility.CreateCommandDisabledException (Driver, "SelectItem.WithDisplayTextContains").Message));
      Assert.That (
          () => control.SelectItem().WithIndex (6),
          Throws.Exception.Message.EqualTo (AssertionExceptionUtility.CreateCommandDisabledException (Driver, "SelectItem.WithIndex").Message));
      Assert.That (
          () => control.SelectItem().WithHtmlID ("body_MyTabbedMenu_MainMenuTabStrip_DisabledCommandTab"),
          Throws.Exception.Message.EqualTo (AssertionExceptionUtility.CreateCommandDisabledException (Driver, "SelectItem.WithHtmlID").Message));
      Assert.That (
          () => control.SelectItem().WithItemID ("DisabledCommandTab"),
          Throws.Exception.Message.EqualTo (AssertionExceptionUtility.CreateCommandDisabledException (Driver, "SelectItem.WithItemID").Message));
      Assert.That (
          () => control.SelectItem ("DisabledCommandTab"),
          Throws.Exception.Message.EqualTo (AssertionExceptionUtility.CreateCommandDisabledException (Driver, "SelectItem(itemID)").Message));
    }
